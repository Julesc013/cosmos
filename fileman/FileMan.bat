...
:: text fades in from black (08, 07, 0f)
:: then BG changes to 1f then to 9f then back to 1f, all while "|\-/|" loading bar is desplayed under fileman text
...
echo.
echo.
CScript Sleep.vbs 400 //NoLogo
echo                                   FileMan v%version%
CScript Sleep.vbs 400 //NoLogo
color 07
CScript Sleep.vbs 400 //NoLogo
color 0f
...
echo.
CScript Sleep.vbs 50 //NoLogo
set "firsttimerun01=yes"
goto fileManStart

:start
set "firsttimerun01=no"
:fileManStart
color 1f
title FileMan v%version%
cls
if %firsttimerun01% == yes goto fileManStart1y
if %firsttimerun01% == no goto fileManStart1n
goto fileManStart1n
:fileManStart1y
CScript Sleep.vbs 400 //NoLogo
:fileManStart1n
...
echo ===============================================================================
echo.
if %firsttimerun01% == yes goto fileManStart2y
if %firsttimerun01% == no goto fileManStart2n
goto fileManStart2n
:fileManStart2y
CScript Sleep.vbs 400 //NoLogo
:fileManStart2n
...
cls
echo.
ctext.exe "{1e} FileMan v%version% \ Exit" {\n}
ctext.exe "{1f}"
echo ===============================================================================
echo.
ctext.exe "{1c}"
...
echo.
echo.
cmdmenusel 0fa1 " Quit FileMan v%version%" " Return to Menu"
if %ERRORLEVEL% == 1 exit
if %ERRORLEVEL% == 2 goto start
goto fileManExitProg